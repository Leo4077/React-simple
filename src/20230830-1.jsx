        ...
        <div className="col-lg-6">
            <article className="card mb-3">
                <div className="row g-0">
                    <div className="col-4">
                        <img src={post.img_url} alt={post.title} className="img-fluid rounded-start h-100" />
                    </div>
                    <div className="col-8">
                        <div className="card-body">
                            <h5 className="card-title">{post.title}</h5>
                            <p className="card-text">{post.description}</p>
                            <time className="card-text"><small className="text-body-secondary">{post.created_at}</small></time>
                        </div>
                    </div>
                </div>
            </article>
